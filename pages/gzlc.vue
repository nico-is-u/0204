		...
		<view class="article-list flex flex-column">
			...
			<view class="article-item" v-for="(item,index) in dataList" :key="index" @click="goDetail(item)">
				...
				<view class="article-content">
					...
					<view class="article-desc" style="margin-top: 20rpx; font-size: 28rpx;">{{ item.desc }}</view>
					<view class="article-desc" style="margin-top: 10rpx; color: #ad1c0b; font-size: 28rpx;">{{ item.info }}</view>
